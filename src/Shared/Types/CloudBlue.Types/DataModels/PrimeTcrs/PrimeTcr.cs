...
public class PrimeTcr : BaseDataModel<long>
{
    ...
    public string? UnitNumberLowered { get; set; }

    public decimal OutsideBrokerCommissionValue { get; set; }

    public decimal OutsideBrokerCommissionPercentage { get; set; }
    ...
    public int[] AgentsIdsArray { get; set; } = null!;

    public int[] ManagersIdsArray { get; set; } = null!;

    public string? ClientName { get; set; }

    public virtual ICollection<PrimeTcrAttachment> PrimeTcrAttachments { get; set; } = new List<PrimeTcrAttachment>();
}