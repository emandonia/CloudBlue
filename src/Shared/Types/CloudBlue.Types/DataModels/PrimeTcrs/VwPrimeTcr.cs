...
public class VwPrimeTcr : BaseDataModel<long>
{
    ...
    public int TcrCompanyId { get; set; }

    public int TcrBranchId { get; set; }
    ...
    public string? TcrBranchName { get; set; }

    public string? TcrCompanyName { get; set; }
    public string? TcrVerificationStatus { get; set; }

    public string? PrimeTcrStatusName { get; set; }
    public string? LeadTicketBranchName { get; set; }

    public int LeadTicketCompanyId { get; set; }
    public string? LeadTicketCompanyName { get; set; }
