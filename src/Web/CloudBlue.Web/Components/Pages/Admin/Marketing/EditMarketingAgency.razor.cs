...
{
    public partial class EditMarketingAgency
    {
        [Inject]
        ...
        {
            marketingAgency = await CloudBlueService.GetMarketingAgencyById(Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await CloudBlueService.UpdateMarketingAgency(Id, marketingAgency);
