...
{
    public partial class AddDevelopersProject
    {
        [Inject]
        ...
        {
            developersProject = new NewCloudBlueMirror.Models.CloudBlue.DevelopersProject();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await CloudBlueService.CreateDevelopersProject(developersProject);
