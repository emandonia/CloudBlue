...
{
    public partial class EditFranchiseBranch
    {
        [Inject]
        ...
        {
            franchiseBranch = await CloudBlueService.GetFranchiseBranchById(Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await CloudBlueService.UpdateFranchiseBranch(Id, franchiseBranch);
